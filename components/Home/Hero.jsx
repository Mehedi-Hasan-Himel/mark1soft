...
const data = [
  {
    id: 1,
    name: "Md.Osman Gani",
    image: "https://i.postimg.cc/Bb8jmFhb/rsz-founder.jpg",
    position: "Founder / CEO",
  },
  {
    id: 2,
    name: "Soniya Akter",
    image: "https://i.postimg.cc/269qdG7g/rsz-1cofounder.jpg",
    position: "Co-Founder & Software Quality Analyst",
  },
  {
    id: 3,
    name: "Hritik Hossain",
    image: "https://i.postimg.cc/MHS9J1LP/rsz-sse.jpg",
    ...
    <div className="z-100 custom-gradient" style={{ paddingTop: "80px" }}>
      <div className="container md:h-[100vh]">
        <div className="flex flex-col-reverse md:flex-row items-center pt-5">
          ...
          >
            <h1
              className="text-[2.5em] lg:text-[4rem] font-semibold"
              style={{ paddinRight: "50px" }}
            >
            ...
            <button
              data-aos="fade-up"
              className="bg-primary text-white p-3 rounded-xl w-full lg:w-[432px]"
            >
              EXPLORE
            </button>
          </div>
